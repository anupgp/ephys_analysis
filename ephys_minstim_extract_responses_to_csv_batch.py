...
# for row in range(6,7):
    ...
    ephys = EphysClass(abffullpath,loaddata=True,badsweeps=None,vclamp = int(vclamp), cclamp = None,fid=fileid)
    ...
    # -----------
    colnames.append("t")
    [colnames.append(fileid+"_sweep"+str(sweep)) for sweep in np.arange(0,ephys.nsweeps)]
    print(colnames)
     # open pandas dataframe to populate data
    print(t.shape,y.shape,len(colnames))
